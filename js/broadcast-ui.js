...
(function() {
    ...
    if (uniqueToken)
        if (location.hash.length > 2) uniqueToken.parentNode.parentNode.parentNode.innerHTML = '<h2 style="text-align:center;"><a id="room-link" href="' + location.href + '" target="_blank">Share this link</a></h2>';
